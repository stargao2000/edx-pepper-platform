...
(function() {
  describe("TabsEditingDescriptor", function() {
    beforeEach(function() {
      ...
      this.descriptor = new TabsEditingDescriptor($('.base_wrapper'));
    ...
    return describe("editor/settings header", function() {
      return it("is hidden", function() {
        return expect(this.descriptor.element.closest(".component-editor").find(".component-edit-header")).toBeHidden();
      });
    });
  });
  ...
  describe("TabsEditingDescriptor special save cases", function() {
    beforeEach(function() {
      ...
      this.isCurrent = "current";
      loadFixtures('tabs-edit.html');
      this.descriptor = new window.TabsEditingDescriptor($('.base_wrapper'));
